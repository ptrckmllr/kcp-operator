...
func (b *CommonShardSpecApplyConfiguration) WithExtraVolumes(values ...v1.Volume) *CommonShardSpecApplyConfiguration {
	for i := range values {
...
func (b *CommonShardSpecApplyConfiguration) WithExtraVolumeMounts(values ...v1.VolumeMount) *CommonShardSpecApplyConfiguration {
	for i := range values {
